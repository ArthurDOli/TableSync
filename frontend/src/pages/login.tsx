...
import { Eye, EyeOff, Mail, Lock, Layers3 } from "lucide-react";
...
export function Login() {
    ...
    async function handleLogin(e: React.FormEvent) {
        ...
        try {
            ...
            setErrors({ general: "Login error. Email or password don't match."})
        }
    }
                ...
                <div className="w-full max-w-md lg:ml-32">
                    ...
                    >
                         <div className="flex flex-col gap-1">
                            ...
                            <p className="text-zinc-400 text-sm mb-4">Log in to your account to enter the table</p>
                        </div>
                        ...
                        <p className="text-center text-sm text-zinc-400 mt-2">
                            Don't have an account? <a href="/register" className="text-white hover:underline">Create one here!</a>
                        </p>
